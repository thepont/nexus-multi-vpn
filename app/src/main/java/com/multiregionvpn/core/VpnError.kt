...
data class VpnError(
     ...
     * Security Note (CWE-209): Raw exception details and stack traces are excluded to prevent information leakage.
     */
    ...
    companion object {
        /**
         * Security Note (CWE-209): Avoid storing raw stack traces in VpnError to prevent sensitive
         * system internal details from leaking via broadcasts or UI logs.
         */
