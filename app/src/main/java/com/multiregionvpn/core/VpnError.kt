...
data class VpnError(
    ...
    fun getUserMessage(): String {
        // SECURITY: We use 'message' for the UI but NOT 'details'.
        // 'details' contains the stack trace (via e.stackTraceToString())
        // which may leak internal information (CWE-209).
        return when (type) {
