...
data class VpnError(
     ...
     * SECURITY: This only returns the high-level message and avoids leaking technical 'details'
     * (like stack traces) to the user, which prevents information leakage (CWE-209).
     */
