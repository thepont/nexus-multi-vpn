...
data class VpnError(
    ...
    /**
     * Returns a user-friendly error message without leaking sensitive internal details or stack traces (CWE-209).
     */
    fun getUserMessage(): String {
        val safeDetail = message
        return when (type) {
    ...
    companion object {
        // SECURITY: Do not record raw stack traces to avoid leaking internal system details or sensitive memory data (CWE-209).
