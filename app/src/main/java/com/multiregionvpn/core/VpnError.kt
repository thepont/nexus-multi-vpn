...
data class VpnError(
     ...
     * Security concern (CWE-209): Raw details/stack traces are excluded from user-facing messages
     * to prevent information disclosure of internal app structures or sensitive memory data.
     */
