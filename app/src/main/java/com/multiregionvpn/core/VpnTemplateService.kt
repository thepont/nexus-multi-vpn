...
class VpnTemplateService @Inject constructor(
    ...
    private suspend fun prepareNordVpnConfig(config: VpnConfig): PreparedVpnConfig {
        ...
        withContext(Dispatchers.IO) {
            ...
            // SECURITY: Set owner-only permissions for the auth file containing credentials
            authFile.setReadable(true, true) // Readable by owner only
            authFile.setWritable(true, true) // Writable by owner only
