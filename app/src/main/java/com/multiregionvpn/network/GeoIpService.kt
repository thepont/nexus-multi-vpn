...
/**
 * Service to retrieve current geographic region securely over HTTPS.
 * Enforces TLS encryption to prevent network eavesdropping and MITM tampering of location data.
 */
class GeoIpService {
