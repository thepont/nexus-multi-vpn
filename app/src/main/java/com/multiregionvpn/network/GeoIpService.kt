...
/**
 * Service to get current geographic region using freeipapi.com over HTTPS.
 * Security Note: HTTPS is enforced to prevent unencrypted network transmission of user location requests.
 */
class GeoIpService {
