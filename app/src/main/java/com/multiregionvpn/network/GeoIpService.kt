...
/**
 * Service to get current geographic region using secure HTTPS freeipapi endpoint.
 * Security: Uses TLS/HTTPS to protect location data and prevent MITM tampering.
 */
class GeoIpService {
