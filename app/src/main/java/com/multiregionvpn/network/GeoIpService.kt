...
/**
 * Service to get current geographic region securely using HTTPS with freeipapi.com
 */
class GeoIpService {
    // Security directive: Use HTTPS endpoint to prevent cleartext HTTP leaks and MITM attacks
