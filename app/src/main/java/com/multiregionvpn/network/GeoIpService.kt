 ...
 *
 * SECURITY NOTE: Switched from insecure http://ip-api.com/ to secure
 * https://freeipapi.com/api/ to prevent man-in-the-middle attacks
 * and comply with cleartext traffic restrictions.
 */
class GeoIpService {
