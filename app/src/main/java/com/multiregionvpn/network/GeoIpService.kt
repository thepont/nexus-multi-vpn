...
/**
 * Service to get current geographic region using secure HTTPS endpoint freeipapi.com
 * Secure HTTPS transmission prevents cleartext MITM credential/location manipulation
 */
class GeoIpService {
