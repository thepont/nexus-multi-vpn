...
/**
 * Service to get current geographic region using a secure HTTPS endpoint.
 */
class GeoIpService {
    // Security: Use HTTPS to encrypt location lookups and prevent cleartext traffic and MITM attacks
