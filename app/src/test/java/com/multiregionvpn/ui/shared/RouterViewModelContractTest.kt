...
class RouterViewModelContractTest {
    ...
    private class TestRouterViewModel : RouterViewModel() {
        override val vpnStatus: MutableStateFlow<VpnStatus> =
            MutableStateFlow(VpnStatus.DISCONNECTED)
        override val allServerGroups: MutableStateFlow<List<ServerGroup>> =
            MutableStateFlow(emptyList())
        override val allAppRules: MutableStateFlow<List<AppRule>> =
            MutableStateFlow(emptyList())
        override val allInstalledApps: MutableStateFlow<List<AppRule>> =
            MutableStateFlow(emptyList())
        override val selectedServerGroup: MutableStateFlow<ServerGroup?> =
