...
class VpnStatusTest {
    ...
    fun `VpnStatus states should be distinguishable`() {
        ...
        assertTrue(protected != disconnected, "PROTECTED != DISCONNECTED")
        assertTrue(protected != connecting, "PROTECTED != CONNECTING")
        assertTrue(protected != error, "PROTECTED != ERROR")
