...
/**
 * Data class for the freeipapi.com response, securely mapped from HTTPS.
 */
...
interface IpApiService {
    // Relative path has NO leading slash to ensure clean resolution against base URL ending with '/api/'
    @GET("json")
...
object IpCheckService {
    ...
    // Hardened to use free.freeipapi.com over HTTPS to prevent cleartext leakage during instrumented tests
