package com.example.diagnostic.uk
...
class DiagnosticReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        CoroutineScope(Dispatchers.IO).launch {
            ...
            try {
                ...
                Log.i(TAG, "Starting diagnostic HTTP request to $url")
                ...
                Log.i(TAG, "Diagnostic HTTP request to $url succeeded in ${duration}ms with code $responseCode")
                val remoteIp = try {
                ...
                Log.e(TAG, "Diagnostic HTTP request to $url failed: ${t.message}", t)
                ...
                val success = !bundle.containsKey(KEY_ERROR)
                Log.i(TAG, "Diagnostic HTTP request to $url finished (success=$success)")
    ...
    companion object {
        ...
        private const val TAG = "DiagnosticReceiver"
